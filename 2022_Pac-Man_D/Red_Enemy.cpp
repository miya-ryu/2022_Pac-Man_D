...
R_ENEMY::R_ENEMY() {
	...
	//当たり判定
	r_enemy.r_left = r_enemy.x - ENEMY_CENTER_HITBOX;
	r_enemy.r_top = r_enemy.y - ENEMY_CENTER_HITBOX;
	r_enemy.r_right = r_enemy.x + ENEMY_CENTER_HITBOX;
	r_enemy.r_bottom = r_enemy.y + PLAYER_CENTER_HITBOX;
}
